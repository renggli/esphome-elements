...
class ClockElement : public Element {
 public:
  ...
  void set_minute_markers(const ClockOptions minute_markers) {
    minute_markers_ = minute_markers;
  }
  void set_hour_markers(const ClockOptions hour_markers) {
    hour_markers_ = hour_markers;
  }
  void set_quarter_markers(const ClockOptions quarter_markers) {
    quarter_markers_ = quarter_markers;
  }
  void set_second_hand(const ClockOptions second_hand) {
    second_hand_ = second_hand;
  }
  void set_minute_hand(const ClockOptions minute_hand) {
